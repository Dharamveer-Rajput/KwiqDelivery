...
public class MapRadar {
    ...
    private volatile int mDistance = 100;                              //distance to which ripple should be shown in metres
    ...
    public MapRadar(GoogleMap googleMap, LatLng latLng, Context context) {
        ...
        mLatLng = latLng;
        mPrevLatLng = latLng;
        mOuterDrawable = (GradientDrawable) ContextCompat.getDrawable(context, R.drawable.backgroundmapcircle);
    }
