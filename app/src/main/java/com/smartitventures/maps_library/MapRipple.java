 ...
 */
package com.smartitventures.maps_library;
...
public class MapRipple {
    ...
    private volatile double mDistance = 100;             //distance to which ripple should be shown in metres
    ...
    private int mStrokeColor = Color.DKGRAY;               //border color of circle
    private int mStrokeWidth = 5;                        //border width of circle
    private long mDurationBetweenTwoRipples = 10;       //in microseconds.
    private long mRippleDuration = 1000;                 //in microseconds
    ...
    public MapRipple(GoogleMap googleMap, LatLng latLng, Context context) {
        ...
        mLatLng = latLng;
        mPrevLatLng = latLng;
        mBackground = (GradientDrawable) ContextCompat.getDrawable(context, R.drawable.backgroundmapcircle);
    ...
    public MapRipple withNumberOfRipples(int numberOfRipples) {
        if (numberOfRipples > 1 || numberOfRipples < 1) {
            numberOfRipples = 1;
        }
